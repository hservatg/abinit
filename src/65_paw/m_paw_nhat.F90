...
!arrays
 ...
 real(dp),intent(out),target :: grnhat12(2,nfft,nspinor**2,3*nhat12_grdim,ndat2,ndat1)
 real(dp),optional,intent(out),target :: grnhat_12(2,nfft,nspinor**2,3,natom*(ider/3),ndat2,ndat1)
 real(dp),intent(out),target :: nhat12(2,nfft,nspinor**2,ndat2,ndat1)
...
!arrays
 ...
 real(dp),allocatable,target :: prod(:,:,:)
